...
test.describe("Vedtak functionality", () => {
    test("should display multiple vedtak in a list with the newest on top", async ({ page, request, baseURL }) => {
        ...
        await msw.mockEndpoint("/api/v1/innsyn/test-soknad-1/vedlegg", [] satisfies VedleggResponse[]);
        ...
        await msw.mockEndpoint("/api/v2/innsyn/test-soknad-1/oppgaver", [] satisfies OppgaveResponseBeta[]);
        await msw.mockEndpoint("/api/v2/innsyn/test-soknad-1/dokumentasjonkrav", [] satisfies DokumentasjonkravDto[]);
