...
export const getHentVedleggQueryKey = (fiksDigisosId: string) => [`/api/v1/innsyn/${fiksDigisosId}/vedlegg`] as const;
...
): UseQueryOptions<Awaited<ReturnType<typeof hentVedlegg>>, TError, TData> & {queryKey: QueryKey} => {
