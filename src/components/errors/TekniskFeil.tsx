...
import { TrengerDuRaskHjelp } from "./TrengerDuRaskHjelp";
import { ErrorPageColumnarLayout } from "./ErrorPageColumnarLayout";
    ...
    return (
        <section className="bg-white flex-col flex grow">
            <ErrorPageColumnarLayout
                leftMargin={<XMarkOctagonIcon className="text-[var(--a-surface-danger)] w-20 h-20" />}
            >
