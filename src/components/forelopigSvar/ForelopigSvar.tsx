...
const ForelopigSvarAlertstripe: React.FC<{}> = () => {
    ...
    let soknadsStatusState: string | null = useSelector((state: InnsynAppState) => state.innsynsdata.soknadsStatus.status);
                ...
                <AlertStripe type="info">
                    ...
                    {forelopigSvar.link && (
                        <EksternLenke href={forelopigSvar.link} target="_blank">
                            <b><FormattedMessage id="historikk.se_vedtaksbrev"/></b>
                        </EksternLenke>
                    )}
                </AlertStripe>
                <br/>
