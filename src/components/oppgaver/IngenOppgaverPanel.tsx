...
import {DokumentasjonEtterspurt, Oppgave, SaksStatusState} from "../../redux/innsynsdata/innsynsdataReducer";
...
const IngenOppgaverPanel: React.FC<Props> = (props: Props) => {
    const x: Oppgave = useSelector((state: InnsynAppState) => state.innsynsdata.oppgaver);
