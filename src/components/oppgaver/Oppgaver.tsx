            ...
            <Panel
                ...
                {brukerHarOppgaver && (
                    <EkspanderbartpanelBase apen={true} heading={(
                        ...
                        <Lenke href="https://www.nav.no/no/NAV+og+samfunn/Kontakt+NAV/Relatert+informasjon/ta-bilde-av-vedleggene-med-mobilen"
                               className="luft_over_10px luft_under_1rem lenke_uten_ramme">Hjelp til å
                            laste opp?</Lenke>
