...
import {NavTable, NavTableHead, NavTableBody, NavTableCell, NavTableHeadCell, NavTableRow} from "./NavTable";
    ...
    return (
        <NavTable columnWidths={[3, 2, 1]}>
            ...
            <NavTableBody>
                ...
                {vedlegg.map((vedlegg: Vedlegg, index: number) => {
                    return (
                        <NavTableRow key={index}>
                            <NavTableCell>
                                <PaperClipSlanted className="ikon_liten_vedlegg" />
                                <Lenke href={"todo"} className="lenke_vedlegg_filnavn">
                                    {vedlegg.filnavn}
                                </Lenke>
