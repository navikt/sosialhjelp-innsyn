export const tekster = {
    nb: {
        ...
        "oppgaver.vilkar.beskrivelse":
            "Les vedtaket ditt for å se om du har vilkår. Dette er aktiviteter du må gjøre som en del av oppfølgingen din fra NAV.",
        "oppgaver.vilkar.dokumentasjonskrav": "Dokumentasjonskrav",
        "oppgaver.vilkar.dokumentasjonskrav.beskrivelse":
            "Les vedtaket ditt for å se om vi trenger mer dokumentasjon fra deg. Dette kan du sende til oss i “Dine vedlegg” fanen under.",
        ...
        "driftsmelding.innsynOgEttersendelseDeaktivert":
            "Vi kan ikke vise deg nyeste status for saken din eller motta filer fra deg. Du kan enten prøve igjen senere, eller dra til NAV kontoret ditt.",
        "driftsmelding.kanIkkeSendeVedlegg":
            "Vi har problemer med systemet og ber deg levere vedlegg på ditt NAV kontor",
    },
};
