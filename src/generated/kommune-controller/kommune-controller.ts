...
export const getHentKommuneInfoUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/kommune`;
};
...
export const getHentKommuneInfoQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/kommune`,
    ] as const;
};
