...
export const getHarSoknaderMedInnsynUrl = () => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/harSoknaderMedInnsyn`;
};
...
export const getHarSoknaderMedInnsynQueryKey = () => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/harSoknaderMedInnsyn`,
    ] as const;
};
