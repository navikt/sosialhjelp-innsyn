...
export const getHentHendelserResponseMock = (overrideResponse: any = {}): HendelseResponse[] =>
...
export const getHentHendelserMockHandler = (overrideResponse?: HendelseResponse[]) => {
    return http.get("*/api/v1/innsyn/:fiksDigisosId/hendelser", async () => {
        await delay(1000);
        return new HttpResponse(JSON.stringify(overrideResponse ? overrideResponse : getHentHendelserResponseMock()), {
            status: 200,
            headers: {
