...
export const getHentHendelserUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/innsyn-wonderwall/sosialhjelp/innsyn-api/api/v1/innsyn/${fiksDigisosId}/hendelser`;
};
...
export const getHentHendelserQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/innsyn-wonderwall/sosialhjelp/innsyn-api/api/v1/innsyn/${fiksDigisosId}/hendelser`,
    ] as const;
};
