...
export const getHentSaksDetaljerUrl = (params: HentSaksDetaljerParams) => {
    ...
    return normalizedParams.size
        ? `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/saksDetaljer?${normalizedParams.toString()}`
        : `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/saksDetaljer`;
};
...
export const getHentAlleSakerUrl = () => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/saker`;
};
...
export const getHentAlleSakerQueryKey = () => {
    return [`https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/saker`] as const;
};
