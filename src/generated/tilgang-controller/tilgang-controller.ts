...
export const getHarTilgangUrl = () => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/tilgang`;
};
...
export const getHarTilgangQueryKey = () => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/tilgang`,
    ] as const;
};
