...
export const getHentSoknadsStatusUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/soknadsStatus`;
};
...
export const getHentSoknadsStatusQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/soknadsStatus`,
    ] as const;
};
