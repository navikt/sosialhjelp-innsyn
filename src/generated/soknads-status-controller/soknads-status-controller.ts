...
export const getHentSoknadsStatusUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/innsyn-wonderwall/sosialhjelp/innsyn-api/api/v1/innsyn/${fiksDigisosId}/soknadsStatus`;
};
...
export const getHentSoknadsStatusQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/innsyn-wonderwall/sosialhjelp/innsyn-api/api/v1/innsyn/${fiksDigisosId}/soknadsStatus`,
    ] as const;
};
