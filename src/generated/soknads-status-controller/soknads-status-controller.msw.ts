...
export const getHentSoknadsStatusMockHandler = (
    overrideResponse?:
        | SoknadsStatusResponse
        | ((
              info: Parameters<Parameters<typeof http.get>[1]>[0]
          ) => Promise<SoknadsStatusResponse> | SoknadsStatusResponse)
) => {
    return http.get("*/api/v1/innsyn/:fiksDigisosId/soknadsStatus", async (info) => {
        await delay(1000);
