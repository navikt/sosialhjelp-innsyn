...
export const getHentSoknadsStatusResponseMock = (overrideResponse: any = {}): SoknadsStatusResponse => ({
...
export const getHentSoknadsStatusMockHandler = (overrideResponse?: SoknadsStatusResponse) => {
    return http.get("*/api/v1/innsyn/:fiksDigisosId/soknadsStatus", async () => {
        await delay(1000);
        return new HttpResponse(
            JSON.stringify(overrideResponse ? overrideResponse : getHentSoknadsStatusResponseMock()),
            {
                status: 200,
                headers: {
...
export const getSoknadsStatusControllerMock = () => [getHentSoknadsStatusMockHandler()];
