...
export const getHentForelopigSvarStatusUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/forelopigSvar`;
};
...
export const getHentForelopigSvarStatusQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/forelopigSvar`,
    ] as const;
};
