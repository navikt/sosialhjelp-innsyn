...
export const getFilOpplastingUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/innsyn-wonderwall/sosialhjelp/innsyn-api/api/v1/digisosapi/${fiksDigisosId}/filOpplasting`;
};
...
export const getOppdaterDigisosSakUrl = (params?: OppdaterDigisosSakParams) => {
    ...
    return normalizedParams.size
        ? `https://www.ekstern.dev.nav.no/sosialhjelp/innsyn-wonderwall/sosialhjelp/innsyn-api/api/v1/digisosapi/oppdaterDigisosSak?${normalizedParams.toString()}`
        : `https://www.ekstern.dev.nav.no/sosialhjelp/innsyn-wonderwall/sosialhjelp/innsyn-api/api/v1/digisosapi/oppdaterDigisosSak`;
};
...
export const getGetInnsynsfilUrl = (digisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/innsyn-wonderwall/sosialhjelp/innsyn-api/api/v1/digisosapi/${digisosId}/innsynsfil`;
};
...
export const getGetInnsynsfilQueryKey = (digisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/innsyn-wonderwall/sosialhjelp/innsyn-api/api/v1/digisosapi/${digisosId}/innsynsfil`,
    ] as const;
};
