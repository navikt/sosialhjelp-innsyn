...
export const getHentUtbetalingerUrl = (params?: HentUtbetalingerParams) => {
    ...
    return normalizedParams.size
        ? `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/utbetalinger?${normalizedParams.toString()}`
        : `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/utbetalinger`;
};
...
export const getHentTidligereUtbetalingerUrl = () => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/tidligere`;
};
...
export const getHentTidligereUtbetalingerQueryKey = () => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/tidligere`,
    ] as const;
};
...
export const getHentNyeUtbetalingerUrl = () => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/nye`;
};
...
export const getHentNyeUtbetalingerQueryKey = () => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/nye`,
    ] as const;
};
