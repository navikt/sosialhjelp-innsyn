...
export const getHentTidligereUtbetalingerQueryKey = () => [`/api/v1/innsyn/tidligere`] as const;
...
>(options?: {
    ...
    request?: SecondParameter<typeof axiosInstance>;
}): UseQueryOptions<Awaited<ReturnType<typeof hentTidligereUtbetalinger>>, TError, TData> & {queryKey: QueryKey} => {
    const {query: queryOptions, request: requestOptions} = options ?? {};
...
export const getHentNyeUtbetalingerQueryKey = () => [`/api/v1/innsyn/nye`] as const;
...
>(options?: {
    ...
    request?: SecondParameter<typeof axiosInstance>;
}): UseQueryOptions<Awaited<ReturnType<typeof hentNyeUtbetalinger>>, TError, TData> & {queryKey: QueryKey} => {
    const {query: queryOptions, request: requestOptions} = options ?? {};
