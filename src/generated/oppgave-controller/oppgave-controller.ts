...
export const getGetVilkarUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/vilkar`;
};
...
export const getGetVilkarQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/vilkar`,
    ] as const;
};
...
export const getGetOppgaverUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/oppgaver`;
};
...
export const getGetOppgaverQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/oppgaver`,
    ] as const;
};
...
export const getGetOppgaveMedIdUrl = (fiksDigisosId: string, oppgaveId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/oppgaver/${oppgaveId}`;
};
...
export const getGetOppgaveMedIdQueryKey = (fiksDigisosId: string, oppgaveId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/oppgaver/${oppgaveId}`,
    ] as const;
};
...
export const getGetHarLevertDokumentasjonkravUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/harLeverteDokumentasjonkrav`;
};
...
export const getGetHarLevertDokumentasjonkravQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/harLeverteDokumentasjonkrav`,
    ] as const;
};
...
export const getGetfagsystemHarDokumentasjonkravUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/fagsystemHarDokumentasjonkrav`;
};
...
export const getGetfagsystemHarDokumentasjonkravQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/fagsystemHarDokumentasjonkrav`,
    ] as const;
};
...
export const getGetDokumentasjonkravUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/dokumentasjonkrav`;
};
...
export const getGetDokumentasjonkravQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/dokumentasjonkrav`,
    ] as const;
};
...
export const getGetDokumentasjonkravMedIdUrl = (fiksDigisosId: string, dokumentasjonkravId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/dokumentasjonkrav/${dokumentasjonkravId}`;
};
...
export const getGetDokumentasjonkravMedIdQueryKey = (fiksDigisosId: string, dokumentasjonkravId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/api/v1/innsyn/${fiksDigisosId}/dokumentasjonkrav/${dokumentasjonkravId}`,
    ] as const;
};
