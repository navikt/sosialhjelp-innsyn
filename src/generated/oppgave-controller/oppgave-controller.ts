...
export const getGetVilkarQueryKey = (fiksDigisosId: string) => [`/api/v1/innsyn/${fiksDigisosId}/vilkar`] as const;
...
): UseQueryOptions<Awaited<ReturnType<typeof getVilkar>>, TError, TData> & {queryKey: QueryKey} => {
...
export const getGetOppgaverQueryKey = (fiksDigisosId: string) => [`/api/v1/innsyn/${fiksDigisosId}/oppgaver`] as const;
...
): UseQueryOptions<Awaited<ReturnType<typeof getOppgaver>>, TError, TData> & {queryKey: QueryKey} => {
    const {query: queryOptions, request: requestOptions} = options ?? {};
...
export const getGetOppgaveMedIdQueryKey = (fiksDigisosId: string, oppgaveId: string) =>
    [`/api/v1/innsyn/${fiksDigisosId}/oppgaver/${oppgaveId}`] as const;
...
>(
...
): UseQueryOptions<Awaited<ReturnType<typeof getOppgaveMedId>>, TError, TData> & {queryKey: QueryKey} => {
    const {query: queryOptions, request: requestOptions} = options ?? {};
    ...
    return {queryKey, queryFn, enabled: !!(fiksDigisosId && oppgaveId), ...queryOptions};
};
...
export const getGetHarLevertDokumentasjonkravQueryKey = (fiksDigisosId: string) =>
    [`/api/v1/innsyn/${fiksDigisosId}/harLeverteDokumentasjonkrav`] as const;
...
): UseQueryOptions<Awaited<ReturnType<typeof getHarLevertDokumentasjonkrav>>, TError, TData> & {queryKey: QueryKey} => {
    const {query: queryOptions, request: requestOptions} = options ?? {};
...
export const getGetfagsystemHarDokumentasjonkravQueryKey = (fiksDigisosId: string) =>
    [`/api/v1/innsyn/${fiksDigisosId}/fagsystemHarDokumentasjonkrav`] as const;
...
): UseQueryOptions<Awaited<ReturnType<typeof getfagsystemHarDokumentasjonkrav>>, TError, TData> & {
    queryKey: QueryKey;
} => {
    const {query: queryOptions, request: requestOptions} = options ?? {};
...
export const getGetDokumentasjonkravQueryKey = (fiksDigisosId: string) =>
    [`/api/v1/innsyn/${fiksDigisosId}/dokumentasjonkrav`] as const;
...
): UseQueryOptions<Awaited<ReturnType<typeof getDokumentasjonkrav>>, TError, TData> & {queryKey: QueryKey} => {
    const {query: queryOptions, request: requestOptions} = options ?? {};
...
export const getGetDokumentasjonkravMedIdQueryKey = (fiksDigisosId: string, dokumentasjonkravId: string) =>
    [`/api/v1/innsyn/${fiksDigisosId}/dokumentasjonkrav/${dokumentasjonkravId}`] as const;
...
>(
...
): UseQueryOptions<Awaited<ReturnType<typeof getDokumentasjonkravMedId>>, TError, TData> & {queryKey: QueryKey} => {
    const {query: queryOptions, request: requestOptions} = options ?? {};
    ...
    return {queryKey, queryFn, enabled: !!(fiksDigisosId && dokumentasjonkravId), ...queryOptions};
};
