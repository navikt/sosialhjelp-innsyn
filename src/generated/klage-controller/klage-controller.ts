...
export const getHentKlagerUrl = (fiksDigisosId: string) => {
    return `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/${fiksDigisosId}/klage`;
};
...
export const getHentKlagerQueryKey = (fiksDigisosId: string) => {
    return [
        `https://www.ekstern.dev.nav.no/sosialhjelp/wonderwall-innsyn/sosialhjelp/innsyn-api/api/v1/innsyn/${fiksDigisosId}/klage`,
    ] as const;
};
